 ...
 */
	...
	public CommandLineRunner commandLineRunner(AppDAO appDAO) {
		...
		return runner -> {
			...
			// findInstructorWithCourses(appDAO);  // change to EAGER Loading
			// findCoursesForInstructor(appDAO);
			findInstructorWithCoursesJoinFetch(appDAO); //Lazy load will not cause any issue as we are using JOIN Fetch DB way
	...
	private void findCoursesForInstructor(AppDAO appDAO) {
		...
		Instructor tempInstructor = appDAO.findInstructorById(theId);
		// Find instructor only, it will not fetch Course as it's lazy loaded.
